...
export const defaultMigrations: Migration[] = [
  ...
  {
    id: "010_affairs",
    file: new URL("../schema/010_affairs.sql", import.meta.url),
  },
  {
  ...
  {
    id: "013_affair_receipts",
    file: new URL("../schema/013_affair_receipts.sql", import.meta.url),
  },
  {
  ...
  {
    id: "015_user_display_name",
    file: new URL("../schema/015_user_display_name.sql", import.meta.url),
  },
];
